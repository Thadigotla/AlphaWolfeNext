  ...
  return (
    ...
    <div className="wrapper">
      <section className="Header">
        <h1 className="Header_one_research">Research</h1>
      </section>
      <iframe
        width="100%"
        height="600"
        src="https://uploads-ssl.webflow.com/63f7267539759cafd312faae/6411c3c5fa4bbb296c560d9f_Research video compressed2-transcode.webm"
      ...
      <section className="Alpha_details_research">
        <p className="Alpha_details_research_para_1">
        ...
        <p className="Alpha_details_research_para_2">
