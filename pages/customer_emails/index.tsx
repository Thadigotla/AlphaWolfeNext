...
const query = gql`query GetCustomerEmails($where: customer_emails_bool_exp,$limit:Int,$offset:Int) {
  customer_emails(where: $where, offset:$offset, limit:$limit,order_by: {uid: desc}) {
    uid
		email
		created_at
		updated_at
...
function MyComponent() {
  ...
  useEffect(()=>{
   if(data?.customer_emails){
      setData(formatData(data?.customer_emails))
   }
