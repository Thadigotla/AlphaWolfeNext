    ...
    <div className="wrapper">
      <section className="Header">
        ...
        <h3 className="Header_two">
          The S-Drive is a digital computer peripheral. Along with its unique
          serial number and programs, it is ‘linked’ via the web, to our secure
          servers and technology centre in Germany.
        </h3>
      </section>
      <iframe
        width="100%"
      ...
      <section className="Alpha_details_block_3">
        <div className="Alpha_details_block_3_left">
          ...
          <div className="Alpha_details_block_3_left_para_2">
            ...
            resonance algorithms to map optimization. We have an extensive
            database of information files including dietary, nutritional and
...
export default SDriveTechnology;