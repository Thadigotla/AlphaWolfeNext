  ...
  return (
    ...
    <div className="wrapper">
      <section className="Header">
        <h1 className="Header_one_gut_support">GUT Support</h1>
      </section>
      <iframe
        width="100%"
        height="600"
      ...
      <section className="Alpha_details_gut_support">
        <p className="Alpha_details_gut_support_para_1">
        ...
        <p className="Alpha_details_gut_support_para_2">
