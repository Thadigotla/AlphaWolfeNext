...
const query = gql`query GetContactDetails($where: contact_details_bool_exp,$limit:Int,$offset:Int) {
  contact_details(where: $where, offset:$offset, limit:$limit,order_by: {uid: desc}) {
    uid
		email
		message
		name
...
function MyComponent() {
  ...
  useEffect(()=>{
   if(data?.contact_details){
      setData(formatData(data?.contact_details))
   }
